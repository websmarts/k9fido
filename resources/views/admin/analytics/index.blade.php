        ...
        <div class="col-md-8 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div> <a href="{{ url('import/products') }}"><button class="btn btn-secondary" 
                    style="margin-right:20px"><i class="fa fa-plus-square-o fa-1x"></i> Import products from spreadsheet</button></a></div>


                    <div style="margin-top:20px;">Export option exports every row in the database</div>
                    <div>
                        <a href="{{ url('export/products') }}"><button class="btn btn-secondary" 
                        style="margin-right:20px"><i class="fa fa-plus-square-o fa-1x"></i> Export all products to spreadsheet</button></a></div>
