...
exports.default = {
  ...
  methods: {
    doneEdit: function doneEdit(price) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d7725506", module.exports)
  } else {
    hotAPI.update("_v-d7725506", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _ClientPrices = require('./ClientPrices.vue');

var _ClientPrices2 = _interopRequireDefault(_ClientPrices);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

new _vue2.default({
  el: '#app',
  components: { ClientPrices: _ClientPrices2.default }
});

},{"./ClientPrices.vue":5,"vue":3}]},{},[6]);
