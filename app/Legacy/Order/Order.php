...
class Order extends Model
{
    ...
    public function client()
    {
        return $this->belongsTo('App\Legacy\Client\Client', 'client_id', 'client_id')
            ->select(['client_id', 'name', 'contacts', 'parent', 'address1', 'address2', 'address3', 'city','state','postcode', 'phone', 'custom_freight', 'freight_notes','level','salesrep','invoice_delivery_method','email_1','email_2','client_note']);
    }
